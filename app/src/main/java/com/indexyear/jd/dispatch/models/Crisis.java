...
/**
 * Created by karibullard on 10/17/17.
 *
 * Properties taken from MCT Referral Form sent by client.
 *
 * Use to set information about crisis response events -- can be used to model client messages and as we're committing data to DB
 */
